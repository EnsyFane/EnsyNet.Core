...
public interface IRepository<T> where T : DbEntity
{
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetAll<TKey>(SortingQuery<T, TKey> sortingQuery);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetMany(PaginationQuery paginationQuery);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetMany<TKey>(PaginationQuery paginationQuery, SortingQuery<T, TKey> sortingQuery);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetManyByExpression(Func<T, bool> filter);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetManyByExpression(Func<T, bool> filter, PaginationQuery paginationQuery);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetManyByExpression<TKey>(Func<T, bool> filter, SortingQuery<T, TKey> sortingQuery);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> GetManyByExpression<TKey>(Func<T, bool> filter, PaginationQuery paginationQuery, SortingQuery<T, TKey> sortingQuery);
    ...
    /// <param name="revertOnFailure">If set to true then if one insertion fails then all insertions will be reverted and the operation fails, otherwise the operation will succeed even if not all entities were succesfully inserted.</param>
    /// <returns>
    /// The inserted entities or <br/>
    /// An <see cref="Errors.BulkInsertOperationFailedError"/> if <paramref name="revertOnFailure"/> is set to true and one insertion fails or <br/>
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<IEnumerable<T>>> Insert(IEnumerable<T> entities, bool revertOnFailure = true);
    ...
    /// <param name="revertOnFailure">If set to true then if one update fails then all updates will be reverted and the operation fails, otherwise the operation will succeed even if not all entities were succesfully updated.</param>
    /// <returns>
    /// The number of updated entities or <br/>
    /// An <see cref="Errors.BulkUpdateOperationFailedError"/> if <paramref name="revertOnFailure"/> is set to true and one update fails or <br/>
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> Update(IEnumerable<T> entities, bool revertOnFailure = true);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> SoftDelete(Guid id);

    /// <summary>
    /// Soft delete multiple entities from the database based on ids.
    /// </summary>
    /// <param name="ids">The ids of the entities to soft delete.</param>
    /// <param name="revertOnFailure">If set to true then if one soft delete fails then all soft deletes will be reverted and the operation fails, otherwise the operation will succeed even if not all entities were succesfully soft deleted.</param>
    /// <returns>
    /// The number of soft deleted entities or <br/>
    /// An <see cref="Errors.BulkDeleteOperationFailedError"/> if <paramref name="revertOnFailure"/> is set to true and one soft delete fails or <br/>
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> SoftDelete(IEnumerable<Guid> ids, bool revertOnFailure = true);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> SoftDelete(Func<T, bool> filter, bool revertOnFailure = true);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> HardDelete(Guid id);

    /// <summary>
    /// Hard delete multiple entities from the database based on ids.
    /// </summary>
    /// <param name="ids">The ids of the entities to hard delete.</param>
    /// <param name="revertOnFailure">If set to true then if one hard delete fails then all hard deletes will be reverted and the operation fails, otherwise the operation will succeed even if not all entities were succesfully hard deleted.</param>
    /// <returns>
    /// The number of hard deleted entities or <br/>
    /// An <see cref="Errors.BulkDeleteOperationFailedError"/> if <paramref name="revertOnFailure"/> is set to true and one hard delete fails or <br/>
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> HardDelete(IEnumerable<Guid> ids, bool revertOnFailure = true);
    ...
    /// An <see cref="Errors.UnexpectedDatabaseError"/> if there was an unexpected database error.
    /// </returns>
    Task<Result<int>> HardDelete(Func<T, bool> filter, bool revertOnFailure = true);
}

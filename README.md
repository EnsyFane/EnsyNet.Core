...
Sonar quality gate: [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=EnsyInc_EnsyNet.Core&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=EnsyInc_EnsyNet.Core)
CI/CD: [![ensy-net-core](https://github.com/EnsyInc/EnsyNet.Core/actions/workflows/ensy-net-core-workflow.yml/badge.svg)](https://github.com/EnsyInc/EnsyNet.Core/actions/workflows/ensy-net-core-workflow.yml)

...
public class UpdateTests : RepositoryTestsBase
{
    ...
    public async Task ExistingEntity_UpdateById_EntityUpdated()
    {
        ...
        updatedEntity.Data!.UpdatedAt.Should().NotBeCloseTo(entity.UpdatedAt!.Value, TimeSpan.FromSeconds(1d));
    ...
    public async Task ExistingEntities_UpdateMultiple_EntitiesUpdated()
    {
        ...
        updatedEntity1.Data!.UpdatedAt.Should().NotBeCloseTo(insertResult1.Data.UpdatedAt!.Value, TimeSpan.FromSeconds(1d));
        ...
        updatedEntity2.Data!.UpdatedAt.Should().NotBeCloseTo(insertResult2.Data.UpdatedAt!.Value, TimeSpan.FromSeconds(1d));
